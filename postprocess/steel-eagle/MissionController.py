...
class MissionController(threading.Thread):
    ...
    def define_mission(self):
        ...
        kwargs["coords"] = "[{'lng': -79.949905, 'lat': 40.4153, 'alt': 0.0},{'lng': -79.95023, 'lat': 40.4153, 'alt': 0.0},{'lng': -79.95005, 'lat': 40.41511, 'alt': 0.0},{'lng': -79.949905, 'lat': 40.4153, 'alt': 0.0}]"
        kwargs["model"] = "coco"
        ...
        kwargs["sample_rate"] = "2"
        kwargs["hover_delay"] = "0"
        kwargs["coords"] = "[{'lng': -79.95027, 'lat': 40.415672, 'alt': 0.0},{'lng': -79.950264, 'lat': 40.41546, 'alt': 0.0},{'lng': -79.94991, 'lat': 40.415455, 'alt': 0.0},{'lng': -79.94991, 'lat': 40.415676, 'alt': 0.0},{'lng': -79.95027, 'lat': 40.415672, 'alt': 0.0}]"
        kwargs["model"] = "coco"
